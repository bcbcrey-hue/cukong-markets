...
Output JSON dari command ini dicetak ke stdout dan otomatis ditulis ke `test_reports/runtime_contract_batch4_current.json` sebagai artefak resmi kontrak target yang harus dipenuhi saat validasi di VPS.
