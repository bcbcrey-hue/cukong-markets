  ...
  return {
    ...
    capitalPlan: {
      ...
      exposure: {
        ...
        pairClass: { key: opportunity.pairClass ?? 'MAJOR', usedNotionalIdr: 0, capNotionalIdr: 100_000, remainingNotionalIdr: 100_000 },
        discoveryBucket: { key: opportunity.discoveryBucket ?? 'LIQUID_LEADER', usedNotionalIdr: 0, capNotionalIdr: 100_000, remainingNotionalIdr: 100_000 },
      },
    },
    capitalContext: {
      policyIntentNotionalIdr: 100_000,
