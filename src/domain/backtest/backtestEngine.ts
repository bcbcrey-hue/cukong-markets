...
export async function simulateBacktestReplay(
  ...
  for (const snapshot of input.snapshots) {
    ...
    openPositions.set(snapshot.pair, {
      ...
      entryStyle: opportunity.recommendedAction === 'SCOUT_ENTER' ? 'SCOUT' : 'CONFIRM',
      pumpState: 'ACTIVE',
      lastContinuationScore: opportunity.continuationProbability,
      lastDumpRisk: opportunity.trapProbability,
      lastScaleOutAt: null,
